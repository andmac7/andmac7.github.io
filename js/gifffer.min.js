...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    function createContainer(w, h, el, altText, opts) {
        ...
        var playButtonStyles = opts && opts.playButtonStyles ? parseStyles(opts.playButtonStyles) : ["width:" + playSize + "px", "height:" + playSize + "px", "border-radius:" + playSize / 2 + "px", "background:#ffffff75", "position:absolute", "top:50%", "left:50%", "margin:-" + playSize / 2 + "px"].join(";");
    ...
    function process(el, gifs, options) {
        ...
        if (w && h && isC)
            cc = createContainer(w, h, el, altText, options);
        el.onload = function() {
            if (!isC)
                return;
            w = w || el.width;
            ...
            con.appendChild(c);
            con.setAttribute("style", "position:relative;cursor:pointer;max-width:" + dims.w + "px;max-height:" + dims.h + "px;background:none;border:none;padding:0;");
            c.style.width = "100%";
            c.style.height = "100%";
